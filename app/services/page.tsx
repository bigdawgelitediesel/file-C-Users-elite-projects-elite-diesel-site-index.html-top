...
export const metadata: Metadata = {
  ...
  description:
    "Full-service diesel repair: engine rebuilds, chassis dyno, ECM diagnostics, proprietary injectors, turbo repair, custom race builds. CAT, Cummins, Detroit, PACCAR, Volvo.",
};
    ...
    services: [
      {
        ...
        desc: "On-site chassis dyno for real-world power measurement, tuning verification, and performance analysis.",
        detail: "We have one of the only chassis dynos in Wyoming. It measures real-world horsepower and torque at the wheels, not estimated numbers, not manufacturer claims. We use it to verify tune results, baseline engines before and after work, diagnose driveability issues that only show up under load, and confirm that performance modifications actually delivered what they promised. If you've had work done elsewhere and want to know what your truck is actually making, bring it in.",
      },
      {
        title: "Engine Dyno Testing",
        desc: "Out-of-chassis engine dyno for verified break-in, power validation, and tune development before the engine ever goes back in the truck.",
        detail: "Chassis dynos measure what reaches the wheels. Our engine dyno measures what the engine actually makes — every pound-foot of torque, every horsepower, every curve from idle to redline — before it ever goes back in the truck. We use it for verified break-in on fresh rebuilds, baseline pulls on customer engines, tune development on race builds, and final QA before delivery. If you want to know exactly what's in the long block before it gets dropped in your frame, this is how you find out.",
      },
      {
